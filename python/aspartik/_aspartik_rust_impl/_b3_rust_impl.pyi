...
from ..data.tree import TreeBuilder as NewickTree
from ..distributions import Continuous, Sample
from ..rng import RNG

class Tree(Scalable):
    def __init__(self, names: TaxonSet, rng: RNG): ...
    ...
    def to_newick(
        self, internal_ids=False, *, clock: Optional[Clock] = None
    ) -> str: ...
    def ola(self) -> list[int]: ...
    def internal_heights(self) -> list[float]: ...
    def depth(self, node: Node) -> int: ...
    def mrca(self, a: Node, b: Node) -> Internal: ...
...
class ClassVector(Sized):
    ...
    def is_changed(self) -> bool: ...
    def set(self, index: int, cls: int): ...
